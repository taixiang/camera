 ...
 * @date 2018/6/26
 */
public class DemoActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
        ...
        if (offset <= scrollRange / 2) {
            ...
            float scale3 = (float) ((scrollRange / 2) - offset) / (scrollRange / 2);
